...
from flask import render_template, flash, Markup, Blueprint
...
staff_namespace = Blueprint('staff', __name__, template_folder='templates', url_prefix='/staff')
...
class TruckCargoView(ModelView):
    ...
    form_excluded_columns = ['date_created', 'is_charged']
    ...
    def scaffold_form(self):
        ...
        form_class.charged = BooleanField()
        return form_class
...
class AdminView(AdminIndexView):
    ...
    def index(self):
        ...
        if current_user.has_role('admin'):
            ...
            users = User.query.filter_by(dispatcher=current_user.id, is_active=True)

            return self.render("admin/custom_staff_index.html", seraching_cargos=seraching_cargos, users=users)


@staff_namespace.route('/truck-cargos-documents/<id>')
